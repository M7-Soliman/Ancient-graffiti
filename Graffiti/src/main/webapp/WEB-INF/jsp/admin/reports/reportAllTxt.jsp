...
<title>Ancient Graffiti Project :: All Textual Graffiti Report</title>
<link href="<%=request.getContextPath()%>/resources/css/reports.css" rel="stylesheet" type="text/css">
</head>
<body>
	<%@include file="/WEB-INF/jsp/header.jsp"%>
	
		<%List<List<String>> info = (List<List<String>>)request.getAttribute("allTxt"); 
	...
	<h1>Report on All Textual Graffiti</h1>
	
	<p>This report returns all inscriptions in the database that aren't marked as figural
	and do not contain content of the form ((:description of figural graffito)).
	</p>
	
	<p> <%=count%> results</p>
	
	<a class="btn btn-outline-secondary" style="color: rgb(51, 51, 51); margin: 1em" href="<%=request.getContextPath()%>/textualTable/csv"
