...
<body>
	...
	<%@include file="/WEB-INF/jsp/header.jsp"%>
		...
		<%List<List<String>> info = (List<List<String>>)request.getAttribute("missingFindspot"); 
	...
	<h1>Report on Graffiti with Missing Findspot</h1>
		
		<p>These have an "unknown" findspot when searched. </p>
		
		<p> <%=count%> results</p>
	
	<a class="btn btn-outline-secondary" href="<%=request.getContextPath()%>/missingFindspotTable/csv">Download CSV <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-download" viewBox="0 0 16 16">
  ...
  <path d="M7.646 11.854a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293V1.5a.5.5 0 0 0-1 0v8.793L5.354 8.146a.5.5 0 1 0-.708.708l3 3z"/><
	...
	<thead class="table-dark tableFixHead">
		...
		<th scope= "col" class = "tableFixHead">Findspot</th>
	</tr>
	</thead>
	<tbody>
			<%
