...
<script>
 function validation(){
 	var x = document.forms["agp_info_form"]["comment_on_update"].value;
 	if (x == null || x == "") {
 		alert("You must comment on any updates to graffiti")
 		return false;
 	}
 }
</script>
...
<body>
	...
	<div class="container" id="parent">
		...
		<p style="text-align: right;">
			<a class="btn btn-agp"
				href="<c:url value="/graffito/AGP-${i.graffitiId}"/>">AGP-<%=inscription.getGraffitiId()%>
				Details Page
			</a> <a class="btn btn-agp"
				href="<%=inscription.getPagePath()%>">Source
				link</a>
		</p>

		<h2>
			Update AGP-<%=inscription.getGraffitiId()%></h2>
			...
			<table class="table table-striped">
				<tbody>
					...
					<tr>
						...
						<td><%=inscription.getSourceFindSpot()!=null?inscription.getSourceFindSpot():""%></td>
					</tr>
					<tr>
						<td class="prop">Writing Style</td>
						<td><%=inscription.getWritingStyle()!=null?inscription.getWritingStyle():""%>
					</tr>
					<tr>
						<td class="prop">Language</td>
						<td><%=inscription.getLanguageInEnglish()%>
					</tr>
					<tr>
						<td class="prop">Measurements</td>
						<td><%=inscription.getMeasurements()!=null?inscription.getMeasurements():""%></td>
					</tr>
					<tr>
		...
		<div id="agp_info">
			<form id="agp_info_form" class="form-horizontal" method="post" action="updateGraffito" onsubmit="return validation()">
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<textarea rows=10 id="epidocContent" name="epidocContent" class="form-control">
							${i.epidocWithLineBreaks}
						</textarea>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
					<input type="text" name="langner" id="langner" class="form-control" value="${i.langner }"/>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<textarea id="summary" name="summary" class="form-control">${i.caption}</textarea>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<textarea name="content_translation" id="content_translation"
							class="form-control">${ i.contentTranslation}</textarea>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<textarea rows=7 id="commentary" name="commentary" class="form-control">${ i.commentary }</textarea>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-1">
						<input type="checkbox" name="figural" id="figural"
							class="form-control"
							<%=inscription.hasFiguralComponent() ? "checked" : ""%>/>
					</div>
				</div>
				
				<div id="drawing_info"
					style="display:<%=inscription.hasFiguralComponent() ? "inline" : "none"%>">
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<textarea name="drawing_description_latin"
								id="drawing_description_latin" class="form-control">${i.figuralInfo.descriptionInLatin}</textarea>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-6">
							<textarea name="drawing_description_english"
								id="drawing_description_english" class="form-control">${i.figuralInfo.descriptionInEnglish}</textarea>
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<input type="text" name="graffito_height" id="graffito_height"
							class="form-control" value="${i.graffitoHeight}">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<input type="text" name="graffito_length" id="graffito_length"
							class="form-control" value="${i.graffitoLength}">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<input type="text" name="letter_height_min" id="letter_height_min"
							class="form-control" value="${i.minLetterHeight}">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<input type="text" name="letter_height_max" id="letter_height_max"
							class="form-control" value="${i.maxLetterHeight}">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<textarea name="character_heights" id="letter_height_max"
							class="form-control">${i.individualLetterHeights}</textarea>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-1">
						<input type="checkbox" name="gh_fig" id="gh_fig"
							class="form-control"
							<%=inscription.isFeaturedFigural() ? "checked" : ""%> />
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-1">
						<input type="checkbox" name="gh_trans" id="gh_trans"
							class="form-control"
							<%=inscription.isFeaturedTranslation() ? "checked" : ""%> />
					</div>
				</div>
				
				<div class="form-group" id="ghCommentary"
					style="display:<%=inscription.isFeaturedTranslation() || inscription.isFeaturedFigural() ? "inline" : "none"%>">
					...
					<div class="col-sm-7">
						<textarea rows="15" name="gh_commentary" id="gh_commentary"
							class="form-control"><%=inscription.getFeaturedGraffitiInfo().getCommentary()%></textarea>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-1">
						<input type="checkbox" name="themed" id="themed"
							class="form-control"
							<%=inscription.isThemed() ? "checked" : ""%> />
					</div>
				</div>
				
				<div id="themes_info"
					style="display:<%=inscription.isThemed() ? "inline" : "none"%>">
					<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<input type="text" name="gh_preferred_image"
							...
							value="<%=inscription.getFeaturedGraffitiInfo().getPreferredImage()%>" />
					</div>
				</div>
				
				<h3>Comment on Update</h3>
				<div class="form-group">
					<label for="comment_on_update" class="col-sm-3 control-label">
						Comment</label>
					<div class="col-sm-6">
						<textarea name="comment_on_update" id="comment_on_update"
